      ...
      <footer className="footer p-10 lg:grid-cols-3 md:justify-items-center my-8 dark:text-white mt-16">
        <div className="w-full">
          ...
          <div>
            ...
            <p className="my-2 text-lg md:text-lg">Support: neasher75@gmail.com</p>
        ...
        <div className="md:justify-self-center">
          ...
          <ul>
            ...
            <Link className="text-lg md:text-lg" to='/blogs'><li className="my-2">Blogs</li></Link>
